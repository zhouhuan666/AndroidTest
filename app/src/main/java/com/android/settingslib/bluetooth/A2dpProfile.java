...
public class A2dpProfile implements LocalBluetoothProfile {
    ...
    public boolean setActiveDevice(BluetoothDevice device) {
        ...
        return device == null
                ? mBluetoothAdapter.removeActiveDevice(BluetoothAdapter.ACTIVE_DEVICE_AUDIO)
                : mBluetoothAdapter.setActiveDevice(device, BluetoothAdapter.ACTIVE_DEVICE_AUDIO);
    }
